defmodule PermitPlaygroundWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PermitPlaygroundWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PermitPlaygroundWeb.Gettext, "errors", msg, opts)
    end
  end
